describe("1. About Arrays", () => {
  ...
  it("should slice arrays", () => {
    ...
    expect(array.slice(2, 2)).toEqual([]); //*empty
    expect(array.slice(2, 20)).toEqual(['and', 'jelly']);
    expect(array.slice(3, 0)).toEqual([]); //*reverse
    expect(array.slice(3, 100)).toEqual(['jelly']);
    expect(array.slice(5, 1)).toEqual([]); //*reverse
  });
  ...
  it("should push and pop", () => {
    ...
    expect(array).toEqual([1, 2, 3]);
    //the push() method adds 1 or more elements to the end of an array and returns the new length of the array
    //the pop() method removes the last value from an array and returns that element
  ...
  it("should know about shifting arrays", () => {
    let array = [1, 2];
    //the unshift() method adds 1 or more elements to the beginning of an array and returns the new length of the array
    array.unshift(3);
